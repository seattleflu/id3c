...
select 1/pg_catalog.has_table_privilege('consensus-genome-processor', 'warehouse.genome', 'select,insert')::int;
...
select 1/pg_catalog.has_column_privilege('consensus-genome-processor', 'warehouse.genome', 'details', 'update')::int;
...
select 1/(not pg_catalog.has_table_privilege('consensus-genome-processor', 'warehouse.genome', 'delete'))::int;
...
select 1/(not pg_catalog.has_column_privilege('consensus-genome-processor', 'warehouse.genome', 'genome_id', 'update'))::int;
select 1/(not pg_catalog.has_column_privilege('consensus-genome-processor', 'warehouse.genome', 'organism_id', 'update'))::int;
select 1/(not pg_catalog.has_column_privilege('consensus-genome-processor', 'warehouse.genome', 'sequence_read_set_id', 'update'))::int;
